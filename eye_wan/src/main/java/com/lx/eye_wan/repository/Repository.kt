...
import com.lx.eye_wan.pagingsource.WanPagingSourceFactory
...
//    lateinit var homeApi: HomeApi
    ...
    @Inject
    lateinit var wanPagingSource: WanPagingSourceFactory

    fun getArticles(): Flow<PagingData<HomeArticle.DatasBean>> {
        return Pager(
            config = PagingConfig(PAGE_SIZE),
            pagingSourceFactory = { wanPagingSource.create() }
        ).flow
    }
}